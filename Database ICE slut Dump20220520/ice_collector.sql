...
CREATE TABLE `collector` (
  ...
  KEY `ing_idx` (`ingID`),
  KEY `jfsa_idx` (`dishID`),
  CONSTRAINT `hsafj` FOREIGN KEY (`dishID`) REFERENCES `dishes` (`dishID`)
